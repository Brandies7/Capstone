...
namespace FamilyPlanner.Controllers
{
    public class CalendarsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Event,StartDate,EndDate")] Calendar calendar)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Event,StartDate,EndDate")] Calendar calendar)
        {
            if (ModelState.IsValid)
            {
